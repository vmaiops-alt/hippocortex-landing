...
const solutions = [
  {
    ...
    description: 'Messages, tool calls, file edits, commands — every interaction becomes a time-ordered episodic trace with full metadata. Automatic salience scoring filters noise. Dedup prevents redundancy. Zero configuration.',
    color: '#00E5CC',
    glowGradient: 'linear-gradient(90deg, rgba(0,229,204,0.4) 0%, transparent 100%)',
  },
  {
    fn: 'learn()',
    tagline: 'Extract Knowledge',
    description: 'The Memory Compiler mines episodes for patterns and promotes them across layers — task schemas from repeated procedures, failure playbooks from errors, causal chains from outcomes, decision policies from preferences. Every artifact backed by source evidence.',
    color: '#8B5CF6',
    glowGradient: 'linear-gradient(90deg, rgba(139,92,246,0.4) 0%, transparent 100%)',
  },
  {
    fn: 'synthesize()',
    tagline: 'Assemble Context',
    description: 'Query all six memory layers simultaneously. Get compressed, provenance-tagged context optimized for your token budget. 60%+ compression over raw retrieval. Deterministic — same inputs, same outputs, every time.',
    color: '#E8E8F0',
    glowGradient: 'linear-gradient(90deg, rgba(232,232,240,0.3) 0%, transparent 100%)',
  },
]
  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-16 md:py-20 lg:py-24">
        ...
        <div className="mt-8 md:mt-10 lg:mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 lg:gap-8 items-start">
