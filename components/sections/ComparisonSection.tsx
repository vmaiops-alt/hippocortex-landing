    ...
    >
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-16 md:py-20 lg:py-24">
        ...
        <ScrollReveal delay={200} className="mt-12">
          <div className="overflow-x-auto" role="table" aria-label="Comparison table">
            {/* Header */}
            <div
              className="grid grid-cols-[minmax(140px,1fr)_minmax(200px,1.5fr)_minmax(200px,1.5fr)] min-w-[600px] border-b border-border-subtle"
              role="row"
            >
              <div className="py-4 px-4 text-sm font-medium text-text-tertiary" role="columnheader">
                Dimension
              </div>
              <div className="py-4 px-4 text-sm font-medium text-text-muted" role="columnheader">
                RAG / Vector DB
              </div>
              <div className="py-4 px-4 text-sm font-medium text-text-primary" role="columnheader">
                Hippocortex
              </div>
            </div>
            ...
            {comparisons.map((row, i) => (
              <ScrollReveal key={row.dimension} delay={100 + i * 80} y={0}>
                <div
                ...
                >
                  <div
                    className="py-4 px-4 text-sm font-medium text-text-tertiary"
                    role="cell"
                  >
                    {row.dimension}
                  </div>
                  <div
                    className="py-4 px-4 text-[17px] max-md:text-sm text-text-muted flex items-start gap-2"
                    role="cell"
                  >
                  ...
                  <div
                    className="py-4 px-4 text-[17px] max-md:text-sm text-text-primary flex items-start gap-2"
                    role="cell"
                  >
                    <svg
                      className="w-4 h-4 text-accent-cyan shrink-0 mt-1"
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth={2}
